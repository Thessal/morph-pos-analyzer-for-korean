# 한국어 형태소분석 및 품사태깅
결합규칙, 엔트리사전 등의 언어자원을 사용해 형태소 분석기를, 세종코퍼스로부터 얻은 통계정보를 통해 품사 태거 만들었다. 형태소 분석과 품사 태깅 개념 및 관련 내용은 [**여기**]()에서 확인할 수 있다. Jupyter notebook을 참고하면 알고리즘 단계별로 출력 결과를 확인할 수 있다.
